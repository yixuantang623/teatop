document.querySelector('.L03Ename').addEventListener('animationend', (event) => {
  ...
  if (event.animationName === "fadeOut") {
    setTimeout(() => {
      ...
      document.querySelector('.R03no , .R03price').style.animation = 'colorfo 0.1s linear 11.5s 1 forwards , colorfo 0.1s linear 16.3s 1 reverse forwards';
